...
/*
 * GP: I've added explicit cast to lines 594 and 596
 * because of MSVC 2005 EE compiler warning
 */
...
static void mts_devseed(
     ...
     */
#ifdef WIN32
    randomunion.randomvalue = (unsigned long)(tb.time * 1000 + tb.millitm);
#else /* WIN32 */
    randomunion.randomvalue = (unsigned long)(tv.tv_sec * 1000000 + tv.tv_usec);
#endif /* WIN32 */
    mts_seed32new(state, randomunion.randomvalue);
    }
